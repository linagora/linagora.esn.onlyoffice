(function() {
  ...
  angular.module('linagora.esn.onlyoffice')
    .factory('onlyOfficeConverter', onlyOfficeConverter);

    function onlyOfficeConverter(fileUtility, cacheManager, guidManager, signatureManager, CONFIG) {
      let service = {
        getConvertedUri: getConvertedUri
      };

      return service;

      function getConvertedUri(documentUri, fromExtension, toExtension, documentRevisionId) {
          let xml = serviceConverter.sendRequestToConvertService(documentUri, fromExtension, toExtension, documentRevisionId);
          let res = serviceConverter.getResponseUri(xml);
